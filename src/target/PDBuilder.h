...
///< Pattern DAG Builder
class PDBuilder : public MachinePass, public InstVisitor<PDBuilder, PatternNode *> {
public:
    ...
    void runOnFunction(Function &function) override {
        ...
        for (auto &Param: function.getParams()) {
            mapValueToNode[Param.get()] = newNode<PhyRegNode>(Param.get(), Register(I++));
        }
    ...
    void buildOnBlock(MachineBlock &mbb) {
        ...
        auto *Node = PatternNode::createNode<RootNode>(RootNodes);
    ...
    PatternNode *visitRet(RetInst *value) override {
        ...
        return newNode<ReturnNode>(value, visit(value->getRetVal()));
    }
