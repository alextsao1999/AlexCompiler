...
import_item -> "[a-zA-Z_][a-zA-Z0-9_]*" @1
             | '*' @1
...
function_declare -> type identifier '(' params ')' block @FunctionDeclare{type:$1, name:$2, params:$4, block:$6}
        ...
        | 'fun' identifier '(' params ')' block @FunctionDeclare{name:$2, params:$4, block:$6}
        | 'fun' identifier '(' params ')' ':' type block @FunctionDeclare{name:$2, params:$4, type: $7, block:$8}
        ;
...
variable_declare -> type identifier ';' @VariableDeclare{type:$1, name:$2}
        ...
        | 'let' identifier '=' expr ';' @VariableDeclare{name:$2, init:$4}
        | 'let' identifier ':' type '=' expr ';' @VariableDeclare{type: $4, name:$2, init:$6}
        ;
...
type   -> identifier @TypeSpecifier{@string_t& typeName:$1}
	...
	| type '[' expr ']' @ArraySpecifier{type: $1, size: $3}
        ;
type_args -> type [$1]
           | type_args ',' type $1[$3]
           ;
...
expr -> expr '<' expr @BinaryExpr{left:$1, @string_t& op:@2, right:$3}
      ...
      | '(' params ')' ':' type '->' block @ArrowExpr{params:$2, returnType:$5, block:$7}
      | '(' params ')' '->' expr @ArrowExpr{params:$2, returnValue:$5}
      | '(' params ')' ':' type '->' expr @ArrowExpr{params:$2, returnType: $5, returnValue:$7}
      | '(' type ')' expr @TypeCast{castTo:$2, value:$4}
      | '(' expr ')' $2
      | '{' args '}' @ElementsList{contents:$2}
      | primary $1
      ;
